...
\end{pmatrix}
$$
так же должно выполняться условие  $\forall i \in [2; n], j \in [1; n - 1]: \,\, A_{i - 1, j} = A_{i, j + 1}$ (в силу того что в зависимости от порядка множителей на место $(i, j)$ может прийти элемент "слева" или "снизу"). Элементы выше и на главной диагонали в матрице $A$ удовлетворяют этому условию.
