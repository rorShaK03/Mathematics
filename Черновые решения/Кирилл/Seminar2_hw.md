...
- $SHIFT^{k - i}$ - матрица сдвига. Она соответствует сдвигу единичной матрицы на $k - i$ столбцов вправо.
...
>[!tip] Формулы сокращенного умножения
>Суть в том, чтобы доказать что они применимы для матрица (с некоммутативным умножением)
