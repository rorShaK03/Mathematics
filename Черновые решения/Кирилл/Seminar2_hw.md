...
Иными словами лямбды имеют вид $\lambda_1 = \lambda_2 = ... = \lambda_{k_1}$

В таком случае равенство $\lambda_k X_{k, k + 1} = \lambda_{k + 1} X_{k, k + 1}$ может выполняться только если $X_{k, k + 1} = 0$.
