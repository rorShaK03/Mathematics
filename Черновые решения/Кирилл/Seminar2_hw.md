...
Значения обозначенные $X_{ij}$ могут принимать любые числовые значения. Можно заметить, что первый случай просто вырожденный второй (размер "подквадрата" равен $1$)
