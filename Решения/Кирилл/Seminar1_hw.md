...
Матрицей удовлетворяющей условиям является матрица над которой проделали операции

1. Прямой и обратный ход алгоритма Гаусса
2. Если какие-то нулевые строки идут не после последней ненулевой, эти нулевые строки перемещают в конец

У такой матрице на главной диагонали единицы (которые делят друг друга) и затем нули.

### Покажем, что достаточно операций 1 типа с ц